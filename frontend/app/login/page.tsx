            ...
            >
                ...
                <div className="text-center mb-8">
                    <div className="w-12 h-12 rounded-xl bg-[var(--accent)] flex items-center justify-center mx-auto mb-4">
                        <span className="font-display text-lg text-white font-bold">R</span>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="absolute right-3 top-9 text-[var(--text-muted)] hover:text-[var(--text-secondary)]"
                        >
                    ...
                    <Button type="submit" className="w-full" isLoading={isLoading}>
                        {!isLoading && <>Sign In <ArrowRight size={16} /></>}
                    </Button>
                </form>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center">
                        <span className="px-3 text-caption text-[var(--text-muted)] bg-[var(--bg-primary)]">or</span>
                    </div>
                </div>
